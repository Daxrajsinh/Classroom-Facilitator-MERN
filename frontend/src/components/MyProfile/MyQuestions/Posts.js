                    ...
                    <div className="all-questions">
                        <div className="all-questions-container">
                            ...
                            <div className="question-answer">
                                <NavLink to={{ pathname: `/answer/${question._id}` }} className="card-title" Style="text-decoration:none;color:black"><h4>{question.title}</h4></NavLink>
                                ...
                                <div className='mt-3'>{question.tags.split(" ").map(tag => <span className='question-tags' Style="color:hsl(120,47%,42%); background-color: hsl(120,46%,92%); border-radius:5px;">{tag}</span>)}</div>
                                <div className="author">
                                    ...
                                    <small className='d-flex flex-row-reverse'>asked {question.date.slice(0, 10)} at {question.date.slice(12, 16)} <p Style="color:rgb(2, 113, 2)">{question.postedBy} &nbsp;</p></small>
