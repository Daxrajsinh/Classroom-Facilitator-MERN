...
function Homepage() {
    ...
    return (
        <>
            ...
            <footer className="text-center" Style="background-color: rgb(2, 113, 2); position:absolute; bottom:0vh;width:100%;">
                <div className="text-center text-white p-3" Style="background-color: rgba(82, 102, 58, 0.05);">
